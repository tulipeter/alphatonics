<template>
 <div id="carouselExampleIndicators" class="carousel slide bg-info">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/img2.jpg" class="d-block w-100" alt="..." style="height: 600px;">
    </div>
  ...
  <div class="container">
    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
      <div class="col-12 col-lg-6 col-xl-5">
        <img class="img-fluid rounded" loading="lazy" src="/who_are_we.jpg" alt="About 1">
      </div>
